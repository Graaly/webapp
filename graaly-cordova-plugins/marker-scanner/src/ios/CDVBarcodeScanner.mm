...
parentViewController:(UIViewController*)parentViewController
  alterateOverlayXib:(NSString *)alternateXib {
    ...
    self.is1D      = YES; // YES - changed by EMA on 01/03
    self.is2D      = YES; // YES - changed by EMA on 01/03
    self.capturing = NO;
...
- (UIView*)buildOverlayView {
    ...
    //bounds = CGRectMake(0, 70, bounds.size.width, (bounds.size.height - 150)); - changed by EMA on 01/03/19
    bounds = CGRectMake(0, 0, bounds.size.width, bounds.size.height);
