<template>
  ...
  <div>
    ...
    <form @submit.prevent="submit()">
      ...
      <q-btn type="submit" color="primary" class="full-width">{{ $t('message.Save') }}</q-btn>
...
export default {
  data() {
    return {
      ...
      durations: [
        { label: '15 ' + this.$t('message.minutes'), value: 15 },
        { label: '30 ' + this.$t('message.minutes'), value: 30 },
        { label: '45 ' + this.$t('message.minutes'), value: 45 },
        { label: '60 ' + this.$t('message.minutes'), value: 60 },
        { label: '90 ' + this.$t('message.minutes'), value: 90 },
        { label: '120 ' + this.$t('message.minutes'), value: 120 }
      ]
    }
  },
  async mounted() {
  ...
  methods: {
    async submit() {
      ...
      if (!this.$v.form.$error) {
        ...
        let successMessage = this.isEdition ? this.$t('message.QuestSaved') : this.$t('message.NewQuestCreated')
