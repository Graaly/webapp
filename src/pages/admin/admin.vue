...
<!--          Best games of the month:
        ...
        <q-tab-panel name="disabled">
          <q-table
            class="container"
            title="Games disabled"
            :data="questDisabled.items"
            :columns="questDisabled.columns"
            :visible-columns="questDisabled.visible"
            row-key="id"
            :loading="questDisabled.loading"
            :pagination="questDisabled.initialPagination"
          >
            <template v-slot:header="props">
              <q-tr :props="props">
                <q-th auto-width />
...
export default {
  ...
  methods: {
     ...
     * List quests rejected
     */
    async loadDisabledQuest() {
      let response = await AdminService.ListQuestDisabled();
      this.questDisabled.items = response.data.disabled;
      console.log(this.questDisabled.items)
