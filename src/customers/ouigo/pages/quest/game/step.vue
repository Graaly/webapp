...
<style>
  .bg-primary {
    background-color: rgb(230, 0, 117) !important;
  }
  /*#q-app {
    max-width: 700px;
  }*/
  .text {
    color: #fff;
    background-color: #e60075 !important;
  }
  .desktop #q-app, .desktop #q-app .step-menu-fixed, .desktop #q-app .fixed-bottom-character {
    margin: auto;
    max-width: 400px;
    overflow: hidden;
  }
  ...
  .desktop #q-app .story .bubble-middle {
    width: 100%;
    padding: 0 50px;
  }
