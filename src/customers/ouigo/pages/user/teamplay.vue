<template>
  <div class="wrapper" style="background-color: #0096ca;">
    <div class="page-content" style="padding-bottom: 100px">

      <!------------------ TITLE AREA ------------------------>
      
      <div class="centered q-pt-lg q-pb-md">
        <img src="statics/customers/ouigo/logo.png" class="logo-top" style="width: 30%; max-width: 200px; margin-bottom: 0px; margin-top: 20px;" />
      </div>
...
export default {
  data() {
    return {
      ...
      teams : [
        { value: "BU Ouigo", label: "BU Ouigo" },
        { value: "Direction établissement", label: "Direction établissement" },
        { value: "CRC", label: "CRC" },
        { value: "COS", label: "COS" },
        { value: "Résidence Paris Montparnasse", label: "Résidence Paris Montparnasse" },
        { value: "Résidence Bordeaux", label: "Résidence Bordeaux" },
        { value: "Résidence Paris gare de Lyon", label: "Résidence Paris gare de Lyon" },
        { value: "Résidence Marne la Vallée", label: "Résidence Marne la Vallée" },
        { value: "Résidence Lyon Saint Exupéry", label: "Résidence Lyon Saint Exupéry" }
      ],
