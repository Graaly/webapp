<template>
  <div id="play-view" class="fit">
    <div :class="controlsAreDisplayed ? 'fadeIn' : 'hidden'">
      ...
      <div class="locate-marker" v-if="step.type == 'locate-marker' || step.type == 'touch-object-on-marker'">
        <transition appear enter-active-class="animated fadeIn" leave-active-class="animated fadeOut">
        ...
        <div v-if="locateMarker.layer !== null && locateMarker.compliant && step.type == 'locate-marker'">
  ...
  methods: {
    ...
    initData () {
      ...
      this.$nextTick(async () => {
        ...
        if ((this.step.type === 'locate-marker' || this.step.type === 'touch-object-on-marker') && !this.playerResult) {
          // user can pass
          this.$emit('pass')
