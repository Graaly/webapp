module.exports = {
  en: {
    ...
    story: {
      ...
      DiscoveryQuest1: "Before you start your first investigation, come with me, I'll show you the basics of the job <b>on a first quest</b>. It will not cost you any energy point <i aria-hidden='true' style='font-size: 1.5em' class='q-icon fas fa-bolt'> </i>",
      ...
      EndQuest1: "Well done, you won <b>{score}</b> !",
      ...
      EndQuest5: "By <b>rating this quest</b>, vous win 2 <i aria-hidden='true' class='q-icon fas fa-bolt'> </i>",
      ...
      MapDetail1: "When you are on the map page, press the <img src='statics/icons/game/menu-main.png' style='width: 30px'> button to <b>access to the map options</b>, and find quests.<br />The <i aria-hidden='true' style='font-size: 1.5em' class='q-icon material-icons bg-primary text-white'>fingerprint</i> button lists the quests you solved or you built.<br />The <i aria-hidden='true' style='font-size: 1.5em' class='q-icon material-icons bg-primary text-white'>group</i> button opens your profile page, with your friends news.",
  ...
  fr: {
    ...
    story: {
      ...
      EndQuest1: "Bien joué, vous avez gagné <b>{score}</b> points !",
