module.exports = {
  en: {
    ...
    story: {
      ...
      DiscoveryQuest9: "<b>A good answer gives you 10 </b> <i aria-hidden='true' class='q-icon fas fa-trophy'> </i> points, a wrong one does not bring you any point.",
      ...
      EndQuest1: "Well done, you won <b>{score}</b> <i aria-hidden='true' class='q-icon fas fa-trophy'> </i> !",
      ...
      MapReturn: "Well done, you have completed your first quest! Press the <b>{score}</b> <i aria-hidden='true' class='q-icon fas fa-trophy'> </i> button to <b>look at your ranking</b>",
  ...
  fr: {
    ...
    story: {
      ...
      MapExplaination3: "Chaque enquête vous rapporte des points <i aria-hidden='true' style='font-size: 1.5em' class='q-icon fas fa-trophy'> </i><br />Vos points <i aria-hidden='true' style='font-size: 1.5em' class='q-icon fas fa-trophy'> </i> sont affichés en haut à droite",
      ...
      QuestParams: "Cette enquête peut rapporter jusqu'à <b>{score}</b> <i aria-hidden='true' class='q-icon fas fa-trophy'> </i>.<br />Elle est de <b>difficulté</b> <img class='image-and-text-aligned' src='statics/icons/game/magnifying-red.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level2}.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level3}.png' />, la <b>durée</b> est estimée à {duration} minutes.",
      description: "{description}",
