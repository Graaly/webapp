...
module.exports = {
  en: {
    ...
    label: {
      ...
      NoQuestPlayedLong: "No quet played. To play a quest, return to the home page!",
      PlayedOn: "Played",
      Succeeded: "Succeeded!",
      ...
      QuestUnderValidation: "Your escape game is now read only. Your quest will be validated by our game master. This can take days. Please check your mailbox for more information",
      ...
      WarningLowBattery: "Your battery is low, please charge it",
      ...
      helpQuestMultiplayer: "This define the minimum number of players to play the game. Each player will have his phone, and should have specific missions in the game. For more information about multiplayer, please watch our Youtube tutos",
  ...
  fr: {
    ...
    label: {
      ...
      YouAlreadyDidThisQuest: "<b>Vous avez déjà réussi cet escape game</b>. Vous pouvez la résoudre à nouveau, mais elle ne vous <b>rapportera aucun point</b>.",
      YouAreQuestOwnerDesc: "Vous êtes le créateur de cet escape game, elle ne vous rapportera aucun point",
