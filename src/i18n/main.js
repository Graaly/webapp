...
module.exports = {
  en: {
    ...
    label: {
      ...
      UploadTheObjectToFind: "Upload a zip file of the object files",
      ...
      CouldNotPlayARStep: "Sorry, your device cannot display the object. So, try to find the object location using the arrow.",
      Step: "Step",
      ...
      MovePremium: "Move this quest to premium",
      PremiumDefinition1: "Give your quest more value!",
      PremiumDefinition2: "Moving premium offers you several advantages : <ul><li><u>A more customized quest to your needs</u>: you can use your own 3D objects & characters, you can display your logo and adapt screens with your colors, ... </li><li><u>A profitable quest</u>: you can sell your quest to players</li><li>You can access the statistics of your quest</li><li>You can have support from our team</li></ul>",
      PremiumDefinition3: "To buy premium credits, look at <a href='https://graaly.com'>our web site</a> or contact us at sales@graaly.com",
      ...
      MembersOfYourOrganizationCreatedPremiumQuests: "Your organization members have created premium quests",
      Status: "Status",
      YouCanCreateNbPremiumQuests: "You can create {nb} premium quest(s) more",
      YouCanNotCreateNewQuests: `Yon can not create new premium quests. Subscribe to our professional offers on <a href="${websiteBaseURL}" target="_blank">${websiteBaseURL}</a> or by email at  <a href="mailto:${salesEmail}">${salesEmail}</a>.`,
  ...
  fr: {
    ...
    label: {
      ...
      UploadTheObjectToFind: "Téléchargez un fichier ZIP de l'objet 3D",
      ...
      CouldNotPlayARStep: "Désolé, votre smartphone ne permet pas d'afficher l'objet. Essayez donc de trouver la position de l'objet en vous aidant de la flèche.",
      Step: "Etape",
      ...
      MembersOfYourOrganizationCreatedPremiumQuests: "Les membres de votre organisation ont créé des enquêtes premium",
      Status: "Statut",
      YouCanCreateNbPremiumQuests: "Vous pouvez encore créer {nb} enquête(s) premium(s)",
      YouCanNotCreateNewQuests: `Vous ne pouvez plus créer d'enquêtes premium. Souscrivez à nos offres professionnelles sur <a href="${websiteBaseURL}" target="_blank">${websiteBaseURL}</a> ou contactez-nous à <a href="mailto:${salesEmail}">${salesEmail}</a>.`,
