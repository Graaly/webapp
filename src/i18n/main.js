module.exports = {
  en: {
    ...
    story: {
      Welcome: "Welcome young detective",
      FirstStep: 'First, please check ...',
      PresentTeam: "Let start to present the team",
      PresentSecretary1: "Hello, I am Sophie, the secretary",
      PresentSecretary2: "I will explain you quests",
      PresentIndicator1: "Hi, I am your indicator",
      PresentIndicator2: "Do not hesitate to ask me hints during quests",
      WelcomeToQuest: "Hello, nice to collaboration with you on this new quest. <br />Please go to this address to start: {startingPlace}",
      QuestParams: "The quest difficulty level is <img class='image-and-text-aligned' src='statics/icons/game/magnifying-red.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level2}.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level3}.png' />, and the estimated duration is {duration} minutes.",
  ...
  fr: {
    ...
    story: {
      ...
      QuestParams: "Cette enquête est de difficulté <img class='image-and-text-aligned' src='statics/icons/game/magnifying-red.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level2}.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level3}.png' />, la durée est estimée à {duration} minutes.",
      description: "{description}",
