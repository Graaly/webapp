...
module.exports = {
  en: {
    ...
    label: {
      ...
      LanguagesPublished: "Game playable in",
      PageLanguagesPublished: "Game visible in",
  ...
  fr: {
    ...
    label: {
      ...
      LanguagesPublished: "Jeu jouable en",
      PageLanguagesPublished: "Fiche visible en",
      ...
      YouAreOfflineYourQuestsList: "Nous n'avons pas réussi à récupérer la liste des escape games (problème réseau). Voici la liste des escape games que vous avez téléchargées, et auxquelles vous pouvez jouer sans réseau :",
      ...
      ScanQRCodeToStartQuest: "Scanner le QR Code d'un escape game",
