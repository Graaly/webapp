module.exports = {
  en: {
    ...
    story: {
      Welcome: "Welcome young detective, you have just joined my team. We have to deal with an increase in inquiries, and have chosen to call someone like you! ",
      FirstStep: "Please let me tell you that there will be work. But if you're motivated and listen to my advice, you'll quickly become a good detective.",
      PresentTeam: "Let start to present our team",
      PresentSecretary1: "Hello, I am Sophie, the secretary",
      PresentSecretary2: "I will give you the more information I can before you start a quest",
      PresentIndicator1: "Hi, I am Marc your indicator",
      ...
      CreateQuest1: "If you create your own quest on a place you know well, you will win 600 <i aria-hidden='true' class='q-icon fas fa-coins'> </i>",
      ...
      EndQuest5: "En notant cette enquête, vous gagnez 2 <i aria-hidden='true' class='q-icon fas fa-coins'> </i>",
  ...
  fr: {
    ...
    story: {
      Welcome: "Bienvenue jeune détective, vous venez de rejoindre mon équipe. Nous devons faire face à une augmentation des enquêtes, et avons choisi de faire appel à quelqu'un de prométeur comme vous !",
      FirstStep: 'Autant vous le dire tout de suite, il va y avoir du boulot. Mais si vous êtes motivé et que vous écoutez mes conseils, vous allez rapidement devenir un bon détective.',
      PresentTeam: "Avant d'aller plus loin, je vais vous présenter notre l'équipe",
      PresentSecretary1: "Bonjour, je suis Sophie, la secrétaire",
      PresentSecretary2: "Je vous ferais un briefing avant chaque enquête. Je chercherai également les personnes qui peuvent vous être utile pour résoudre une énigme.",
      PresentIndicator1: "Salut, je suis Marc, votre indic.",
      PresentIndicator2: "Si vous bloquez sur certaines enquêtes, appelez moi !",
      StartPlaying: "Ne perdons pas plus de temps, cliquez sur une des enquêtes, représentée par l'image <img src='statics/icons/game/pointer-quest.png' /> sur la carte",
      WelcomeToQuest1: "Bonjour, ravie de collaborer avec vous sur cette nouvelle enquête",
      WelcomeToQuest2: "Rendez l'adresse suivante pour commencer : {startingPlace}",
      QuestParams: "Cette enquête peut vous rapporter jusqu'à {score} <i aria-hidden='true' class='q-icon fas fa-trophy'> </i>.<br />Elle est de difficulté <img class='image-and-text-aligned' src='statics/icons/game/magnifying-red.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level2}.png' /><img class='image-and-text-aligned' src='statics/icons/game/magnifying-{level3}.png' />, la durée est estimée à {duration} minutes.",
      description: "{description}",
      QuestIsFarFromUser: "Vous n'êtes pas sur le lieu de l'enquête.<br />En résolvant cette enquête à distance, vous allez manquer plein d'indices et donc de points",
      YouAlreadyDidThisQuest: "Vous avez déjà réussi cette enquête. Vous pouvez la résoudre à nouveau, mais elle ne vous rapportera aucun point",
      ...
      hint: "Salut, voici un indice : {hint}",
      DiscoveryQuest1: "Avant de te lancer dans ta première enquête, vient avec moi, je vais te montrer les bases du métier",
      RankingDescription1: "L'onglet Classement vous permet de frimer auprès des autres détectives !",
      RankingDescription2: "Sous l'image <i aria-hidden='true' class='q-icon material-icons text-yellow-5'>public</i> s'affiche votre classement mondial, et sous l'image <i aria-hidden='true' class='q-icon material-icons text-yellow-5'>home</i> s'affiche votre classement local",
      RankingDescription3: "Les territoires vous permettent de savoir votre progression dans la résolution des enquêtes d'une ville. Quand vous avez résolu toutes les enquêtes d'une ville, vous avez conquis le territoire !",
      RankingDescription4: "Touchez le bouton <i aria-hidden='true' class='q-icon material-icons bg-primary text-white'>group</i>, dans le menu du bas, pour accéder à votre profil et aux infos de vos amis",
      CompleteProfile1: "N'oubliez pas de bien compléter votre profil, pour que je puisse vous contacter sans problème.",
      CompleteProfile2: "Dès que c'est bon, touchez le bouton <img src='statics/icons/game/menu-main.png' style='width: 40px'>.",
      CreateQuest1: "Etre le premier sur un lieu que vous connaissez bien pour y créer une enquête rapporte 600 <i aria-hidden='true' class='q-icon fas fa-coins'> </i>",
      CreateQuest2: "Vous pouvez aussi gagner de l'argent si votre enquête est très populaire",
      CreateQuest3: "Mais c'est surtout le moyen de s'amuser à faire cogiter tous les autres enquêteurs en leur créant des énigmes",
      AddFriends: "N'oubliez pas d'ajouter vos amis. Cela permet de suivre leur évolution, de jouer à leur enquêtes et de comparer vos résultats",
      DiscoveryQuest2: "Votre enquête se décompose en plusieurs étapes, qui peuvent être soit une page descriptive comme ici, soit une énigme",
      DiscoveryQuest3: "La barre du bas est le menu de navigation de votre enquête.",
      DiscoveryQuest4: "Le bouton <i aria-hidden='true' class='q-icon material-icons'>menu</i> vous permet de revoir la description de l'enquête, et de quitter l'enquête en cours.",
      DiscoveryQuest5: "Le bouton <i aria-hidden='true' class='q-icon material-icons'>arrow_back</i> vous permet de revenir à l'étape précédente. Par contre, vous ne gagnerez pas de point supplémentaire si vous avez déjà répondu à l'énigme.",
