...
module.exports = {
  en: {
    ...
    label: {
      ...
      SaveQuestResultsMarker: "Your player can scan a QR Code to save their score with Graaly. For that, create 3 QR Codes (on https://www.qr-code-generator.com/ for instance) with the values: <br /><strong>{questId}_score{score3}</strong> for players who exited the room in time<br /><strong>{questId}_score{score2}</strong> for players who were close to exit the room in time<br /><strong>{questId}_score{score1}</strong> for players that did not exit the room",
  ...
  fr: {
    ...
    label: {
      ...
      PublicProQuestDesc1: "Votre escape game est jouable par tous les joueurs Graaly. Aucun numéro de carte n'est demandé. Graaly partage les risques avec vous.",
      ...
      MarkersToStartQuest: "Vous pouvez permettre aux joueurs d'accéder directement à l'escape game, avec ou sans compte utilisateur. Pour cela, créez un QR code (par exemple sur le site https://www.qr-code-generator.com/) ayant la valeur <strong>{code}</strong>",
      SaveQuestResultsMarker: "Vos joueurs peuvent scanner un QR Code pour enregistrer leur score dans Graaly. Pour cela, créez 3 QR Codes (on https://www.qr-code-generator.com/ par exemple) avec les valeurs : <br /><strong>{questId}_score{score3}</strong> pour les joueurs qui sont sortis de la salle dans les temps<br /><strong>{questId}_score{score2}</strong> pour les joueurs qui sont presque sortis dans les temps<br /><strong>{questId}_score{score1}</strong> pour les joueurs qui ne sont pas sortis",
      ...
      YouAreQuestOwnerDesc: "Vous êtes le <b>créateur de cet escape game</b>, elle ne vous rapportera aucun point",
