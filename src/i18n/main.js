module.exports = {
  en: {
    ...
    story: {
      ...
      DiscoveryQuest8: "Cette étape de l'enquête est une énigme, où il vous faut toucher l'image correspondant à la bonne réponses, sur 4 options possibles",
  ...
  fr: {
    ...
    story: {
      ...
      StartPlaying: "Ne perdons pas plus de temps, Je vous emmène sur une enquête, cliquez sur votre position représentée par <img src='statics/icons/game/pointer-me.png' /> pour démarrer",
      WelcomeToQuest1: "Bonjour, ravie de collaborer avec vous sur cette nouvelle enquête",
      WelcomeToQuest2: "Rendez l'adresse suivante pour commencer : <b>{startingPlace}</b>",
      ...
      DiscoveryQuest8: "Cette étape de l'enquête est <b>une énigme</b>.<br />Il vous faut appuyer sur l'image correspondant à la bonne réponses, sur 4 options possibles",
      ...
      StartNewQuest1: "Bon, on s'est assez reposé, <b>démarrons une nouvelle enquête</b> !",
      StartNewQuest2: "Je vous propose qu'on s'occupe de l'enquête <strong>{quest}</strong> ! Beaucoup s'y sont cassé les dents, y arriverez-vous ?",
