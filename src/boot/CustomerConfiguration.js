...
// ============== BOSCH =============
/*
import CustomerUserLogin from '../customers/bosch/pages/user/login'
import CustomerQuestPlayHome from '../customers/bosch/pages/quest/game/intro'
import CustomerQuestPlayStep from '../customers/bosch/pages/quest/game/step'
import CustomerQuestPlayEnd from '../customers/bosch/pages/quest/game/end'
